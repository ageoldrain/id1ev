...
class Introduction1point6(Page):
    """
    Third introduction page providing some information about the game.
    """
    def is_displayed(self):
        return self.round_number == 1
...
page_sequence = [Introduction, Introduction1point5, Introduction1point6, Introduction2, ChooseCoin, RevealCoinOutcome, ChoosePermutation, Results]
